 ...
 * [boot0001.bin](https://github.com/lowRISC/lowrisc-chip/releases/download/v0.6-rc2/boot0001.bin):
...
Download and write the bitstream
    ...
    curl -L https://github.com/lowRISC/lowrisc-chip/releases/download/v0.6-rc2/boot0001.bin > boot0001.bin
